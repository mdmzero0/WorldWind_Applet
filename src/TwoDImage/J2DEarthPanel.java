...
//    Color landOutlineColor = Color.WHITE;
    ...
    public J2DEarthPanel(Hashtable<String,AbstractSatellite> satHash, Time currentTime, Sun sun)
    {
...
//        }
    ...
    private void iniObject(Hashtable<String,AbstractSatellite> satHash)
    {
        ...
        imageMap = new J2dEarthLabel2(planetImage,aspectRatio, satHash, backgroundColor, currentTime, sun, this);
